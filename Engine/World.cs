...
namespace Engine
{
    public static class World
    {
        ...
        public const int ITEM_ID_UNARMED = 11;
        ...
        private static void PopulateItems()
        {
            ...
            _items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5, 30));
            ...
            _items.Add(new Weapon(ITEM_ID_UNARMED, "Fist", "Fists", 0, 2, UNSELLABLE_ITEM_PRICE));
        }
        ...
        private static void PopulateLocations()
        {
            ...
            alchemist.AddItemToInventory(ItemByID(ITEM_ID_HEALING_POTION), 5);
            alchemistHut.VendorWorkingHere = alchemist;

            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many plants are growing here.");
            alchemistsGarden.AddMonster(MONSTER_ID_RAT, 50);
            alchemistsGarden.AddMonster(MONSTER_ID_SNAKE, 50);
            ...
            Location bridge = new Location(LOCATION_ID_BRIDGE, "Bridge", "A stone bridge crosses a wide river.", ItemByID(ITEM_ID_ADVENTURER_PASS));
